...
yarn build
cd ..
rsync -avp $(printf "./%s/dist/js/" "$WEBPACK_REPO") $(printf "./%s/resources/js/" "$API_TIER_REPO")
rsync -avp $(printf "./%s/dist/css/" "$WEBPACK_REPO") $(printf "./%s/resources/css/" "$API_TIER_REPO")
